...
namespace com.core
{
    ...
    {
        public static int runNameId(string nName)
        {
            return runHash(nName, 0x50);
        }

        public static int runPasswardId(string nName)
        {
            return runHash(nName, 0x300);
        }

        public static int runClusterID(string nName)
        {
            return runHash(nName, 0x100);
        }

        public static int runServerID(string nName)
        {
            return runHash(nName, 0x150);
        }

        public static int runDatabaseId(string nName)
        {
            return runHash(nName, 0x200);
        }

        public static int runTableId(string nName)
        {
            return runHash(nName, 0x250);
        }
        ...
        public static int runComputer()
        {
            return runCommon(@"computer");
        }

        public static int runCellphone()
        {
            return runCommon(@"cellphone");
        }

        static int runHash(string nKey, int nOffset)
        {
